...
test('HU DEP VS HOT muestran Áreas de Unidad y Áreas de Central, no gerentes', () => {
  ...
  assert.match(catalog, /management_ids_input: \[\.\.\.selectedManagementIds, \.\.\.selectedCentralManagementIds\]/)
